...
class UnitUpdateStubTest {

    private val processor = MkplUnitProcessor()
    private val id = MkplUnitId("777")
    private val name = "Litre"
    private val description = "a metric unit of volume"
    private val alias = "l"
    private val status = MkplUnitStatus.DEPRECATED
